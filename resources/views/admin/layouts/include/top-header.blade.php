...
<div class="header" style="background: lightseagreen">
    <div class="header-left active">
        ...
        <a href="https://dreamspos.dreamguystech.com/laravel/template/public/index" class="logo-small">
            <img src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/logo-small.png" alt="">
        </a>
    ...
    <ul class="nav user-menu">
            ...
            <div class="top-nav-search">
                ...
                <form action="#">
                    ...
                    <a class="btn" id="searchdiv"><img
                            src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/icons/search.svg"
                            alt="img"></a>
                </form>
            </div>
        </li>
        ...
        <li class="nav-item dropdown has-arrow flag-nav">
            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                <img src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/flags/us1.png"
                     alt="" height="20">
            </a>
        ...
        <li class="nav-item dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <img
                    src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/icons/notification-bing.svg"
...
<img alt="" src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/profiles/avatar-02.jpg">
</span>
                        ...
                        <li class="notification-message">
                            <a href="https://dreamspos.dreamguystech.com/laravel/template/public/activities">
                                <div class="media d-flex">
<span class="avatar flex-shrink-0">
<img alt="" src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/profiles/avatar-03.jpg">
</span>
                                    <div class="media-body flex-grow-1">
                        ...
                        <li class="notification-message">
                            <a href="https://dreamspos.dreamguystech.com/laravel/template/public/activities">
                                <div class="media d-flex">
<span class="avatar flex-shrink-0">
<img alt="" src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/profiles/avatar-06.jpg">
</span>
                                    <div class="media-body flex-grow-1">
                        ...
                        <li class="notification-message">
                            <a href="https://dreamspos.dreamguystech.com/laravel/template/public/activities">
                                <div class="media d-flex">
<span class="avatar flex-shrink-0">
<img alt="" src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/profiles/avatar-17.jpg">
</span>
                                    <div class="media-body flex-grow-1">
                        ...
                        <li class="notification-message">
                            <a href="https://dreamspos.dreamguystech.com/laravel/template/public/activities">
                                <div class="media d-flex">
<span class="avatar flex-shrink-0">
<img alt="" src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/profiles/avatar-13.jpg">
</span>
                                    <div class="media-body flex-grow-1">
...
<span class="user-img"><img
        src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/profiles/avator1.jpg" alt="">
...
<span class="status online"></span></span>
                    ...
                    <a class="dropdown-item"
                       href="https://dreamspos.dreamguystech.com/laravel/template/public/profile"> <i class="me-2"
                                                                                                      data-feather="user"></i>
                        My Profile</a>
                    <a class="dropdown-item"
    ...
    <div class="dropdown mobile-user-menu">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item" href="https://dreamspos.dreamguystech.com/laravel/template/public/signin">Logout</a>
        </div>
    </div>
