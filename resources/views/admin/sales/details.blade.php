        ...
        <div class="page-header text-blue-d2">
            ...
            <div class="page-tools">
                <div class="action-buttons">
                    ...
                    <a class="btn bg-white btn-light mx-1px text-95" href="{{route('admin.sale.invoice',$sale->id)}}" data-title="PDF">
                            ...
                            <div class="row bg-gradient-cyan">
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <span
                                            class="text-600 text-110 text-blue align-middle">{{$sale->customer->name}}</span>
                                    </div>
                                    <div class="text-grey-m2">
                                        ...
                                        <div class="my-1">
                                            {{$sale->customer->city_id}}
                                            , {{$sale->customer->country_id}}
                                        </div>
                                        <div class="my-1"><i class="fa fa-phone fa-flip-horizontal text-secondary"></i>
                                            <b class="text-600">{{$sale->customer->phone}}</b></div>
                                    </div>
                                </div>
                                <!-- /.col -->
                                ...
                                <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                                    ...
                                    <div class="text-grey-m2">
                                        ...
                                        <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                            ...
                                            {{$sale->sale_payment->created_at->format('d M y')}}
                                        </div>
                                        <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                                class="text-600 text-90">Total:</span>
                                            {{$sale->sale_payment->total}}
                                        </div>
                                        <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                                class="text-600 text-90">Paid:</span>
                                            {{$sale->sale_payment->paid}}
                                        </div>
                                        <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                                class="text-600 text-90">Status:{{$sale->sale_payment->total < $sale->sale_payment->paid ? 'Paid':'Due'}}</span> <span
                                    ...
                                    <div class="row">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                @forelse($sale->sale_details as $item)
                                                    <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" class="text-end"><h5 id="grand_total">৳ {{$sale->sale_payment->total}}</h5>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
